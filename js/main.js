// --- DATA ---
const projects = [
  { id: 1,  title: "Restaurant Management System", desc: "A web-based restaurant management system for handling orders, menus, and reservations.",              lang: "PERN Stack", category: "backend",  demo: "",                                   github: "https://github.com/ukvalens/codealpha_tasks" },
  { id: 2,  title: "Event Registration System",     desc: "An event registration platform allowing users to register and manage event attendance.",            lang: "PERN Stack", category: "backend",  demo: "",                                   github: "https://github.com/ukvalens/codealpha_tasks" },
